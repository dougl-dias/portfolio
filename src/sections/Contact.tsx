    ...
    <Section id='contact'>
      ...
      <div className='grid md:grid-cols-5 gap-10'>
        <div className='space-y-6 order-2 md:order-1 md:col-span-2'>
          <div className='p-6 rounded-xl bg-card/60 border backdrop-blur'>
        ...
        <div className='p-8 rounded-xl bg-card/60 border backdrop-blur overflow-hidden order-1 sm:order-2 md:col-span-3'>
          ...
          <form>
            <div className='grid grid-cols-3 gap-4'>
              ...
              <Button type='submit' color='primary' effect='scale' icon={GrSend} className='col-span-full mt-2'>
                Enviar mensagem
              </Button>
            </div>
          </form>
